...
import
  ./openmp, ./gemm_packing_omp, ./gemm_omp
...
template dispatch(
  ...
  when defined(i386) or defined(amd64):
    when T is float32:
      if hasAvx512f():   dispatch_opt(x86_AVX512)
      elif hasFma3():    dispatch_opt(x86_AVX_FMA)
      elif hasAvx():     dispatch_opt(x86_AVX)
      elif hasSse():     dispatch_opt(x86_SSE)
    elif T is float64:
      if hasAvx512f():   dispatch_opt(x86_AVX512)
      elif hasFma3():    dispatch_opt(x86_AVX_FMA)
      elif hasAvx():     dispatch_opt(x86_AVX)
      elif hasSse2():    dispatch_opt(x86_SSE2)
    elif T is int32 or T is uint32:
      if hasAvx512f():   dispatch_opt(x86_AVX512)
      elif hasAvx2():    dispatch_opt(x86_AVX2)
      elif hasSse41():   dispatch_opt(x86_SSE4_1)
      elif hasSse2():    dispatch_opt(x86_SSE2)
    elif T is int64:
      if hasAvx512f():   dispatch_opt(x86_AVX512)
      elif hasSse2():    dispatch_opt(x86_SSE2)
